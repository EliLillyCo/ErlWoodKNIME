...
/**
 * Panel used to configure the GetChildClasses OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetChildClasses extends AbstractSettingsPanel implements ISettingsPanel<OpenPhactsNodeModel.eMethod, OpenPhactsSettings> {
	/**
	 * Serial Id.
	 */
	...
	private AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetChildClassesSettings.URISetting, OpenPhactsSettings> uri = new AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetChildClassesSettings.URISetting, OpenPhactsSettings>() {
		...
		@Override
		protected GetChildClassesSettings.URISetting getSettings(OpenPhactsSettings settings) {
			return settings.getChildClassesSettings().getURISettings();
		}
		...
		protected String getHintText() {
			return "Please enter an Class URI string";
		}
	...
	@Override
	public eMethod getMethod() {
		return eMethod.GetChildClasses;
	}
