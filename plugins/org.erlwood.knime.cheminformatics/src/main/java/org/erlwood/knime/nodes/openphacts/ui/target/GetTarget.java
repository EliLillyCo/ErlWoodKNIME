...
/**
 * Panel used to configure the GetTarget OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetTarget extends AbstractSettingsPanel implements ISettingsPanel<OpenPhactsNodeModel.eMethod, OpenPhactsSettings> {
	/**
	 * Serial Id.
	 */
	...
	private AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetTargetSettings.URISetting, OpenPhactsSettings> uri = new AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetTargetSettings.URISetting, OpenPhactsSettings>() {
		...
		@Override
		protected GetTargetSettings.URISetting getSettings(OpenPhactsSettings settings) {
			return settings.getTargetSettings().getURISettings();
		}
