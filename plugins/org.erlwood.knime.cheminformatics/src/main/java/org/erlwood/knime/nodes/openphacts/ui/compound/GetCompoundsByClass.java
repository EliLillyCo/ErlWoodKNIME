...
/**
 * Panel used to configure the GetCompoundByClass OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetCompoundsByClass extends AbstractSettingsPanel implements ISettingsPanel<OpenPhactsNodeModel.eMethod, OpenPhactsSettings> {
	/**
	 * Serial Id.
	 */
	...
	private AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetCompoundsByClassSettings.URISetting, OpenPhactsSettings> uri = new AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetCompoundsByClassSettings.URISetting, OpenPhactsSettings>() {
		...
		@Override
		protected GetCompoundsByClassSettings.URISetting getSettings(OpenPhactsSettings settings) {
			return settings.getCompoundsByClassSettings().getURISettings();
		}
		...
		protected String getHintText() {
			return "Please enter Class URI string";
		}
	...
	@Override
	public eMethod getMethod() {
		return eMethod.GetCompoundsByClass;
	}
