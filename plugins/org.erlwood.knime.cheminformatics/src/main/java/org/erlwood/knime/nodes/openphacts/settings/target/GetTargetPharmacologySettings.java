...
/**
 * Settings container for the GetTargetPharmacology OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetTargetPharmacologySettings  {
	private URISetting 		uri 		= new URISetting();
	
	public static class URISetting extends AbstractColumnAndValueSettings {

		@Override
		public String getColumnConfigKey() 		{	return "TARGET_PHARMACOLOGY_URI_COLUMN";		}

		@Override
		public String getValueConfigKey() 		{	return "TARGET_PHARMACOLOGY_URI_VALUE";		}

		@Override
		protected String getUseColumnConfigKey()	{	return "USE_TARGET_PHARMACOLOGY_URI_COLUMN";	}
