...
/**
 * Panel used to configure the GetParent OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetParentClasses extends AbstractSettingsPanel implements ISettingsPanel<OpenPhactsNodeModel.eMethod, OpenPhactsSettings> {
	/**
	 * Serial Id.
	 */
	...
	private AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetParentClassesSettings.URISetting, OpenPhactsSettings> uri = new AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetParentClassesSettings.URISetting, OpenPhactsSettings>() {
		...
		@Override
		protected GetParentClassesSettings.URISetting getSettings(OpenPhactsSettings settings) {
			return settings.getParentClassesSettings().getURISettings();
		}
	...
	@Override
	public eMethod getMethod() {
		return eMethod.GetParentClasses;
	}
