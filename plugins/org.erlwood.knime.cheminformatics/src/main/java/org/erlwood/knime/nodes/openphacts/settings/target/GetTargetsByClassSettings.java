...
/**
 * Settings container for the GetTargetsByClasses OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetTargetsByClassSettings  {
	private URISetting 		uri 		= new URISetting();
	
	public static class URISetting extends AbstractColumnAndValueSettings {

		@Override
		public String getColumnConfigKey() 		{	return "TARGETS_BY_CLASS_URI_COLUMN";		}

		@Override
		public String getValueConfigKey() 		{	return "TARGETS_BY_CLASS_URI_VALUE";		}

		@Override
		protected String getUseColumnConfigKey()	{	return "USE_TARGETS_BY_CLASS_URI_COLUMN";	}
