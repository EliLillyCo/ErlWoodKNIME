...
/**
 * Settings container for the GetDiseasesByTarget OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetDiseasesByTargetSettings  {
	private URISetting 		uri 		= new URISetting();
	
	public static class URISetting extends AbstractColumnAndValueSettings {

		@Override
		public String getColumnConfigKey() 		{	return "DISEASES_BY_TARGET_URI_COLUMN";		}

		@Override
		public String getValueConfigKey() 		{	return "DISEASES_BY_TARGET_URI_VALUE";		}

		@Override
		protected String getUseColumnConfigKey()	{	return "USE_DISEASES_BY_TARGET_URI_COLUMN";	}
