...
/**
 * Settings container for the GetCompoundClasses OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetCompoundClassesSettings  {
	private URISetting 		uri 		= new URISetting();
	
	public static class URISetting extends AbstractColumnAndValueSettings {

		@Override
		public String getColumnConfigKey() 		{	return "COMPOUND_CLASSES_URI_COLUMN";		}

		@Override
		public String getValueConfigKey() 		{	return "COMPOUND_CLASSES_URI_VALUE";		}

		@Override
		protected String getUseColumnConfigKey()	{	return "USE_COMPOUND_CLASSES_URI_COLUMN";	}
