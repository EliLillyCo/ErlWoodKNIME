...
/**
 * Panel used to configure the GetTargetCopmpoundClasses OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetTargetCompoundClasses extends AbstractSettingsPanel implements ISettingsPanel<OpenPhactsNodeModel.eMethod, OpenPhactsSettings> {
	/**
	 * Serial Id.
	 */
	...
	private AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetTargetCompoundClassesSettings.URISetting, OpenPhactsSettings> uri = new AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetTargetCompoundClassesSettings.URISetting, OpenPhactsSettings>() {
		...
		@Override
		protected GetTargetCompoundClassesSettings.URISetting getSettings(OpenPhactsSettings settings) {
			return settings.getTargetCompoundClassesSettings().getURISettings();
		}
	 ...
	 * Constructor.
	 */
	public GetTargetCompoundClasses() {	
	...
	@Override
	public eMethod getMethod() {
		return eMethod.GetTargetCompoundClasses;
	}
