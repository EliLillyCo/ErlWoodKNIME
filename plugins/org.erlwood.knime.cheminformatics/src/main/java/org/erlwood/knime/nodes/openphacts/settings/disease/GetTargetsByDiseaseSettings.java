 ...
 * ------------------------------------------------------------------------
*/
package org.erlwood.knime.nodes.openphacts.settings.disease;
...
/**
 * Settings container for the GetTargetsByDisease OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetTargetsByDiseaseSettings  {
	private URISetting 		uri 		= new URISetting();
	
	public static class URISetting extends AbstractColumnAndValueSettings {

		@Override
		public String getColumnConfigKey() 		{	return "TARGETS_BY_DISEASE_URI_COLUMN";		}

		@Override
		public String getValueConfigKey() 		{	return "TARGETS_BY_DISEASE_URI_VALUE";		}

		@Override
		protected String getUseColumnConfigKey()	{	return "USE_TARGETS_BY_DISEASE_URI_COLUMN";	}
		
		@Override
		protected String getColumnValidationFailMessage() {		
			return "You must specify a valid Disease URI column";
		}

		@Override
		protected String getValueValidationFailMessage() {
			return "You must specify a valid Disease URI value";
		}		
	};
