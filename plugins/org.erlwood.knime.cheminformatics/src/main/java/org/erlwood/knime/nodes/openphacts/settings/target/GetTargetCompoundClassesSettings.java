...
/**
 * Settings container for the GetTargetCompoundClasses OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetTargetCompoundClassesSettings  {
	private URISetting 		uri 		= new URISetting();
	
	public static class URISetting extends AbstractColumnAndValueSettings {

		@Override
		public String getColumnConfigKey() 		{	return "TARGET_COMPOUND_CLASSES_URI_COLUMN";		}

		@Override
		public String getValueConfigKey() 		{	return "TARGET_COMPOUND_CLASSES_URI_VALUE";		}

		@Override
		protected String getUseColumnConfigKey()	{	return "USE_TARGET_COMPOUND_CLASSES_URI_COLUMN";	}
		
		@Override
		protected String getColumnValidationFailMessage() {		
			return "You must specify a valid Target URI column";
		}

		@Override
		protected String getValueValidationFailMessage() {
			return "You must specify a valid Target URI value";
		}		
	};
