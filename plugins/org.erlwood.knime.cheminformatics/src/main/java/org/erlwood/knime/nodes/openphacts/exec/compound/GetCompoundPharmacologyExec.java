...
public class GetCompoundPharmacologyExec extends AbstractPagingExec {
	...
	protected String getMethod() {
		return "compound/pharmacology/pages";
	}
	...
	protected String getCountMethod() {
		return "compound/pharmacology/count";
	}
	...
	protected void initialiseSettings(BufferedDataTable input, OpenPhactsSettings openPhactsSettings) {
		...
		GetCompoundPharmacologySettings s = openPhactsSettings.getCompoundPharmacologySettings();
