...
/**
 * Panel used to configure the GetTargetClasses OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetTargetClasses extends AbstractSettingsPanel implements ISettingsPanel<OpenPhactsNodeModel.eMethod, OpenPhactsSettings> {
	/**
	 * Serial Id.
	 */
	...
	private AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetTargetClassesSettings.URISetting, OpenPhactsSettings> uri = new AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetTargetClassesSettings.URISetting, OpenPhactsSettings>() {
		...
		@Override
		protected GetTargetClassesSettings.URISetting getSettings(OpenPhactsSettings settings) {
			return settings.getTargetClassesSettings().getURISettings();
		}
	...
	@Override
	public eMethod getMethod() {
		return eMethod.GetTargetClasses;
	}
