...
/**
 * Settings container for the GetCompound OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetCompoundSettings  {
	private URISetting 		uri 		= new URISetting();
	
	public static class URISetting extends AbstractColumnAndValueSettings {

		@Override
		public String getColumnConfigKey() 		{	return "COMPOUND_URI_COLUMN";		}

		@Override
		public String getValueConfigKey() 		{	return "COMPOUND_URI_VALUE";		}

		@Override
		protected String getUseColumnConfigKey()	{	return "USE_COMPOUND_URI_COLUMN";	}
