...
public class GetTargetPharmacologyExec extends AbstractPagingExec {
	...
	protected String getMethod() {
		return "target/pharmacology/pages";
	}
	...
	protected String getCountMethod() {
		return "target/pharmacology/count";
	}
	...
	protected void initialiseSettings(BufferedDataTable input, OpenPhactsSettings openPhactsSettings) {
		...
		GetTargetPharmacologySettings s = openPhactsSettings.getTargetPharmacologySettings();
