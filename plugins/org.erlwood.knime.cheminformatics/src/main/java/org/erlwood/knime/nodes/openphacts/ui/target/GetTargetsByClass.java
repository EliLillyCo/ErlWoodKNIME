...
/**
 * Panel used to configure the GetTargetsByClass OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetTargetsByClass extends AbstractSettingsPanel implements ISettingsPanel<OpenPhactsNodeModel.eMethod, OpenPhactsSettings> {
	/**
	 * Serial Id.
	 */
	...
	private AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetTargetsByClassSettings.URISetting, OpenPhactsSettings> uri = new AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetTargetsByClassSettings.URISetting, OpenPhactsSettings>() {
		...
		@Override
		protected GetTargetsByClassSettings.URISetting getSettings(OpenPhactsSettings settings) {
			return settings.getTargetsByClassSettings().getURISettings();
		}
	...
	@Override
	public eMethod getMethod() {
		return eMethod.GetTargetsByClass;
	}
