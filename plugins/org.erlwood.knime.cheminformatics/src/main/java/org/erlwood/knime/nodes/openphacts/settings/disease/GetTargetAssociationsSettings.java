...
/**
 * Settings container for the GetTargetAssociations OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetTargetAssociationsSettings  {
	private URISetting 		uri 		= new URISetting();
	
	public static class URISetting extends AbstractColumnAndValueSettings {

		@Override
		public String getColumnConfigKey() 		{	return "TARGET_ASSOC_URI_COLUMN";		}

		@Override
		public String getValueConfigKey() 		{	return "TARGET_ASSOC_URI_VALUE";		}

		@Override
		protected String getUseColumnConfigKey()	{	return "USE_TARGET_ASSOC_URI_COLUMN";	}
