 ...
 * ------------------------------------------------------------------------
*/
package org.erlwood.knime.nodes.openphacts.exec.target;
...
public class GetTargetPharmacologyByClassExec extends AbstractPagingExec {
	...
	protected String getMethod() {
		return "target/tree/pharmacology/pages";
	}
	...
	protected String getCountMethod() {
		return "target/tree/pharmacology/count";
	}
	...
	protected void initialiseSettings(BufferedDataTable input, OpenPhactsSettings openPhactsSettings) {
		...
		GetTargetPharmacologyByClassSettings s = openPhactsSettings.getTargetPharmacologyByClassSettings();
