 ...
 * ------------------------------------------------------------------------
*/
package org.erlwood.knime.nodes.openphacts.ui.assay;
 ...
 *
 */
public class GetAssay extends AbstractSettingsPanel implements ISettingsPanel<OpenPhactsNodeModel.eMethod, OpenPhactsSettings> {
	/**
	 * Serial Id.
	 */
	...
	private AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetAssaySettings.URISetting, OpenPhactsSettings> uri = new AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetAssaySettings.URISetting, OpenPhactsSettings>() {
		...
		@Override
		protected GetAssaySettings.URISetting getSettings(OpenPhactsSettings settings) {
			return settings.getAssaySettings().getURISettings();
		}
		...
		protected String getHintText() {
			return "Please enter an Assay URI string";
		}
