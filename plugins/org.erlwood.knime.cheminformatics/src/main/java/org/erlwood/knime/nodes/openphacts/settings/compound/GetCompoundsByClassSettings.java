...
/**
 * Settings container for the GetCompoundsByClass OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetCompoundsByClassSettings  {
	private URISetting 		uri 		= new URISetting();
	
	public static class URISetting extends AbstractColumnAndValueSettings {

		@Override
		public String getColumnConfigKey() 		{	return "COMPOUNDS_BY_CLASS_URI_COLUMN";		}

		@Override
		public String getValueConfigKey() 		{	return "COMPOUNDS_BY_CLASS_URI_VALUE";		}

		@Override
		protected String getUseColumnConfigKey()	{	return "USE_COMPOUNDS_BY_CLASS_URI_COLUMN";	}
