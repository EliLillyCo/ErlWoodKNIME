 ...
 * ------------------------------------------------------------------------
*/
package org.erlwood.knime.nodes.openphacts.settings.classes;
...
/**
 * Settings container for the GetParentClasses OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetParentClassesSettings  {
	private URISetting 		uri 		= new URISetting();
	
	public static class URISetting extends AbstractColumnAndValueSettings {

		@Override
		public String getColumnConfigKey() 		{	return "PARENT_CLASSES_URI_COLUMN";		}

		@Override
		public String getValueConfigKey() 		{	return "PARENT_CLASSES_URI_VALUE";		}

		@Override
		protected String getUseColumnConfigKey()	{	return "USE_PARENT_CLASSES_URI_COLUMN";	}
