...
/**
 * Settings container for the GetChildClasses OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetChildClassesSettings  {
	private URISetting 		uri 		= new URISetting();
	
	public static class URISetting extends AbstractColumnAndValueSettings {

		@Override
		public String getColumnConfigKey() 		{	return "CHILD_CLASSES_URI_COLUMN";		}

		@Override
		public String getValueConfigKey() 		{	return "CHILD_CLASSES_URI_VALUE";		}

		@Override
		protected String getUseColumnConfigKey()	{	return "USE_CHILD_CLASSES_URI_COLUMN";	}
