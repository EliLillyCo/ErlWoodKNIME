...
/**
 * Panel used to configure the GetDisease OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetDisease extends AbstractSettingsPanel implements ISettingsPanel<OpenPhactsNodeModel.eMethod, OpenPhactsSettings> {
	/**
	 * Serial Id.
	 */
	...
	private AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetDiseaseSettings.URISetting, OpenPhactsSettings> uri = new AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetDiseaseSettings.URISetting, OpenPhactsSettings>() {
		...
		@Override
		protected GetDiseaseSettings.URISetting getSettings(OpenPhactsSettings settings) {
			return settings.getDiseaseSettings().getURISettings();
		}
