...
/**
 * Settings container for the GetDiseaseAssociations OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetDiseaseAssociationsSettings  {
	private URISetting 		uri 		= new URISetting();
	
	public static class URISetting extends AbstractColumnAndValueSettings {

		@Override
		public String getColumnConfigKey() 		{	return "DISEASE_ASSOC_URI_COLUMN";		}

		@Override
		public String getValueConfigKey() 		{	return "DISEASE_ASSOC_URI_VALUE";		}

		@Override
		protected String getUseColumnConfigKey()	{	return "USE_DISEASE_ASSOC_URI_COLUMN";	}
