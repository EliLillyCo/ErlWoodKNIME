...
public class GetTargetAssociationsExec extends AbstractExec {
	...
	protected void initialiseSettings(BufferedDataTable input, OpenPhactsSettings openPhactsSettings) {
		...
		GetTargetAssociationsSettings s = openPhactsSettings.getTargetAssociationsSettings();
