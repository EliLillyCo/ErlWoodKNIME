 ...
 * ------------------------------------------------------------------------
*/
package org.erlwood.knime.nodes.openphacts.settings.target;
...
/**
 * Settings container for the GetTargetPharmacologyByClass OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetTargetPharmacologyByClassSettings  {
	private URISetting 		uri 		= new URISetting();
	
	public static class URISetting extends AbstractColumnAndValueSettings {

		@Override
		public String getColumnConfigKey() 		{	return "TARGET_PHARMACOLOGY_BY_CLASS_URI_COLUMN";		}

		@Override
		public String getValueConfigKey() 		{	return "TARGET_PHARMACOLOGY_BY_CLASS_URI_VALUE";		}

		@Override
		protected String getUseColumnConfigKey()	{	return "USE_TARGET_PHARMACOLOGY_BY_CLASS_URI_COLUMN";	}
		
		@Override
		protected String getColumnValidationFailMessage() {		
			return "You must specify a valid Class URI column";
		}

		@Override
		protected String getValueValidationFailMessage() {
			return "You must specify a valid Class URI value";
		}		
	};
