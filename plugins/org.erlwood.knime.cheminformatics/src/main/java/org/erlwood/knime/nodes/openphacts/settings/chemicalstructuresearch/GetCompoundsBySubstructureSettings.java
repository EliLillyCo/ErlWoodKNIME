...
/**
 * Settings container for the GetCompoundsBySubstructure OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetCompoundsBySubstructureSettings  {
	private SmilesSetting 			smiles 		= new SmilesSetting();
	private MoleculeTypeSetting 	molType 	= new MoleculeTypeSetting();

	
	public static class SmilesSetting extends AbstractColumnAndValueSettings {

		@Override
		public String getColumnConfigKey() 		{	return "SUBSTRUCTURE_SMILES_COLUMN";		}

		@Override
		public String getValueConfigKey() 		{	return "SUBSTRUCTURE_SMILES_VALUE";		}

		@Override
		protected String getUseColumnConfigKey()	{	return "USE_SUBSTRUCTURE_SMILES_COLUMN";	}
	...
	public static class MoleculeTypeSetting extends AbstractValueSettings  {


		@Override
		public String getValueConfigKey() 		{	return "SUBSTRUCTURE_MOL_TYPE_VALUE";		}


		@Override
		protected String getValidationFailMessage() {
			return "You must specify a valid Mol Type";
		}
	...
	public void loadSettingsFrom(final NodeSettingsRO settings) throws InvalidSettingsException {
		...
		molType.loadSettingsFrom(settings);					
	}
	...
	public void saveSettingsTo(final NodeSettingsWO settings) {
		...
		molType.saveSettingsTo(settings);
	}
	
	public void validateSettings(NodeSettingsRO settings) throws InvalidSettingsException {
		smiles.validateSettings(settings);
		molType.validateSettings(settings);	
	}
	...
	public MoleculeTypeSetting getMoleculeTypeSettings() {
		return molType;
	}
