 ...
 * ------------------------------------------------------------------------
*/
package org.erlwood.knime.nodes.openphacts.ui.disease;
...
/**
 * Panel used to configure the GetDiseaseAssociations OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetDiseaseAssociations extends AbstractSettingsPanel implements ISettingsPanel<OpenPhactsNodeModel.eMethod, OpenPhactsSettings> {
	/**
	 * Serial Id.
	 */
	...
	private AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetDiseaseAssociationsSettings.URISetting, OpenPhactsSettings> uri = new AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetDiseaseAssociationsSettings.URISetting, OpenPhactsSettings>() {
		...
		@Override
		protected GetDiseaseAssociationsSettings.URISetting getSettings(OpenPhactsSettings settings) {
			return settings.getDiseaseAssociationsSettings().getURISettings();
		}
		...
		protected String getHintText() {
			return "Please enter an Disease URI string";
		}
	...
	@Override
	public eMethod getMethod() {
		return eMethod.GetDiseaseAssociations;
	}
