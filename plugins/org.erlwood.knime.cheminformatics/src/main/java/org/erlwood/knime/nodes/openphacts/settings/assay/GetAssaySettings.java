 ...
 * ------------------------------------------------------------------------
*/
package org.erlwood.knime.nodes.openphacts.settings.assay;
...
/**
 * Settings container for the GetAssay OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetAssaySettings  {
	private URISetting 		uri 		= new URISetting();
	
	public static class URISetting extends AbstractColumnAndValueSettings {

		@Override
		public String getColumnConfigKey() 		{	return "ASSAY_URI_COLUMN";		}

		@Override
		public String getValueConfigKey() 		{	return "ASSAY_URI_VALUE";		}

		@Override
		protected String getUseColumnConfigKey()	{	return "USE_ASSAY_URI_COLUMN";	}
		
		@Override
		protected String getColumnValidationFailMessage() {		
			return "You must specify a valid Assay URI column";
		}

		@Override
		protected String getValueValidationFailMessage() {
			return "You must specify a valid Assay URI value";
		}		
	};
