...
public class GetTargetCompoundClassesExec extends AbstractExec {
	...
	protected String getMethod() {
		return "target/classificationsForCompounds";
	}
	...
	protected void initialiseSettings(BufferedDataTable input, OpenPhactsSettings openPhactsSettings) {
		...
		GetTargetCompoundClassesSettings s = openPhactsSettings.getTargetCompoundClassesSettings();
