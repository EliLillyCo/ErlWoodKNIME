...
public class GetDiseasesByTargetExec extends AbstractExec {
	...
	protected void initialiseSettings(BufferedDataTable input, OpenPhactsSettings openPhactsSettings) {
		...
		GetDiseasesByTargetSettings s = openPhactsSettings.getDiseasesByTargetSettings();
