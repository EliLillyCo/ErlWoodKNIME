...
public class GetTargetsByDiseaseExec extends AbstractExec {
	...
	protected void initialiseSettings(BufferedDataTable input, OpenPhactsSettings openPhactsSettings) {
		...
		GetTargetsByDiseaseSettings s = openPhactsSettings.getTargetsByDiseaseSettings();
