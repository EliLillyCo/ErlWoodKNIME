...
/**
 * Panel used to configure the GetCompoundPharmacology OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetCompoundPharmacology extends AbstractSettingsPanel implements ISettingsPanel<OpenPhactsNodeModel.eMethod, OpenPhactsSettings> {
	/**
	 * Serial Id.
	 */
	...
	private AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetCompoundPharmacologySettings.URISetting, OpenPhactsSettings> uri = new AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetCompoundPharmacologySettings.URISetting, OpenPhactsSettings>() {
		...
		@Override
		protected GetCompoundPharmacologySettings.URISetting getSettings(OpenPhactsSettings settings) {
			return settings.getCompoundPharmacologySettings().getURISettings();
		}
	 ...
	 * Constructor.
	 */
	public GetCompoundPharmacology() {	
	...
	@Override
	public eMethod getMethod() {
		return eMethod.GetCompoundPharmacology;
	}
