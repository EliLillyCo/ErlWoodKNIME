...
/**
 * Settings container for the GetDisease OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetDiseaseSettings  {
	private URISetting 		uri 		= new URISetting();
	
	public static class URISetting extends AbstractColumnAndValueSettings {

		@Override
		public String getColumnConfigKey() 		{	return "DISEASE_URI_COLUMN";		}

		@Override
		public String getValueConfigKey() 		{	return "DISEASE_URI_VALUE";		}

		@Override
		protected String getUseColumnConfigKey()	{	return "USE_DISEASE_URI_COLUMN";	}
