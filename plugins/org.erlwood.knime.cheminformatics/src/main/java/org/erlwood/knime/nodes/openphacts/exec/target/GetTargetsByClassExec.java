...
public class GetTargetsByClassExec extends AbstractPagingExec {
	...
	protected void initialiseSettings(BufferedDataTable input, OpenPhactsSettings openPhactsSettings) {
		...
		GetTargetsByClassSettings s = openPhactsSettings.getTargetsByClassSettings();
