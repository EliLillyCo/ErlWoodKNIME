...
/**
 * Settings container for the GetTargetClasses OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetTargetClassesSettings  {
	private URISetting 		uri 		= new URISetting();
	
	public static class URISetting extends AbstractColumnAndValueSettings {

		@Override
		public String getColumnConfigKey() 		{	return "TARGET_CLASSES_URI_COLUMN";		}

		@Override
		public String getValueConfigKey() 		{	return "TARGET_CLASSES_URI_VALUE";		}

		@Override
		protected String getUseColumnConfigKey()	{	return "USE_TARGET_CLASSES_URI_COLUMN";	}
