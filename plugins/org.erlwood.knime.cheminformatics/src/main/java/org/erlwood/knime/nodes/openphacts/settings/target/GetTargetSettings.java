...
/**
 * Settings container for the GetTarget OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetTargetSettings  {
	private URISetting 		uri 		= new URISetting();
	
	public static class URISetting extends AbstractColumnAndValueSettings {

		@Override
		public String getColumnConfigKey() 		{	return "TARGET_URI_COLUMN";		}

		@Override
		public String getValueConfigKey() 		{	return "TARGET_URI_VALUE";		}

		@Override
		protected String getUseColumnConfigKey()	{	return "USE_TARGET_URI_COLUMN";	}
