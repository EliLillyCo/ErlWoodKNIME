...
/**
 * Panel used to configure the GetDiseasesByTarget OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetDiseasesByTarget extends AbstractSettingsPanel implements ISettingsPanel<OpenPhactsNodeModel.eMethod, OpenPhactsSettings> {
	/**
	 * Serial Id.
	 */
	...
	private AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetDiseasesByTargetSettings.URISetting, OpenPhactsSettings> uri = new AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetDiseasesByTargetSettings.URISetting, OpenPhactsSettings>() {
		...
		@Override
		protected GetDiseasesByTargetSettings.URISetting getSettings(OpenPhactsSettings settings) {
			return settings.getDiseasesByTargetSettings().getURISettings();
		}
	...
	@Override
	public eMethod getMethod() {
		return eMethod.GetDiseasesByTarget;
	}
