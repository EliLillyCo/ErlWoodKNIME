...
/**
 * Panel used to configure the GetTargetAssociations OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetTargetAssociations extends AbstractSettingsPanel implements ISettingsPanel<OpenPhactsNodeModel.eMethod, OpenPhactsSettings> {
	/**
	 * Serial Id.
	 */
	...
	private AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetTargetAssociationsSettings.URISetting, OpenPhactsSettings> uri = new AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetTargetAssociationsSettings.URISetting, OpenPhactsSettings>() {
		...
		@Override
		protected GetTargetAssociationsSettings.URISetting getSettings(OpenPhactsSettings settings) {
			return settings.getTargetAssociationsSettings().getURISettings();
		}
		...
		protected String getHintText() {
			return "Please enter an Target URI string";
		}
	...
	@Override
	public eMethod getMethod() {
		return eMethod.GetTargetAssociations;
	}
