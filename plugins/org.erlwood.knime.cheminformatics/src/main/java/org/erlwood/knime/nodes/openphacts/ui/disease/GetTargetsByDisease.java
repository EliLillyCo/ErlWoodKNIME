...
/**
 * Panel used to configure the GetTargetsByDisease OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetTargetsByDisease extends AbstractSettingsPanel implements ISettingsPanel<OpenPhactsNodeModel.eMethod, OpenPhactsSettings> {
	/**
	 * Serial Id.
	 */
	...
	private AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetTargetsByDiseaseSettings.URISetting, OpenPhactsSettings> uri = new AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetTargetsByDiseaseSettings.URISetting, OpenPhactsSettings>() {
		...
		@Override
		protected GetTargetsByDiseaseSettings.URISetting getSettings(OpenPhactsSettings settings) {
			return settings.getTargetsByDiseaseSettings().getURISettings();
		}
	...
	@Override
	public eMethod getMethod() {
		return eMethod.GetTargetsByDisease;
	}
