...
public final class Gradient {
	 ...
	 */
	public static final Color[] GRADIENT_MAROON_TO_GOLD = createGradient(
			new Color(0xA0, 0x00, 0x00), new Color(0xFF, 0xFF, 0x00), 500);

	/**
	 * Produces a gradient from blue (low) to red (high)
	 */
	public static final Color[] GRADIENT_BLUE_TO_RED = createGradient(
			Color.BLUE, Color.RED, 500);

	/**
	 * Produces a gradient from black (low) to white (high)
	 */
	public static final Color[] GRADIENT_BLACK_TO_WHITE = createGradient(
			Color.BLACK, Color.WHITE, 500);

	/**
	 * Produces a gradient from red (low) to green (high)
	 */
	public static final Color[] GRADIENT_RED_TO_GREEN = createGradient(
			Color.RED, Color.GREEN, 500);

	/**
	 * Produces a gradient through green, yellow, orange, red
	 */
	public static final Color[] GRADIENT_GREEN_YELLOW_ORANGE_RED = createMultiGradient(
	 ...
	 * orange, red
	 */
	public static final Color[] GRADIENT_RAINBOW = createMultiGradient(
	 ...
	 */
	public static final Color[] GRADIENT_HOT = createMultiGradient(new Color[] {
	 ...
	 * white)
	 */
	public static final Color[] GRADIENT_HEAT = createMultiGradient(
	 ...
	 */
	public static final Color[] GRADIENT_ROY = createMultiGradient(new Color[] {
