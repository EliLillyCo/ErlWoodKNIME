...
public class GetCompoundClassesExec extends AbstractExec {
	...
	protected String getMethod() {
		return "compound/classifications";
	}
	...
	protected void initialiseSettings(BufferedDataTable input, OpenPhactsSettings openPhactsSettings) {
		...
		GetCompoundClassesSettings s = openPhactsSettings.getCompoundClassesSettings();
