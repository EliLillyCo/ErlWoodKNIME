...
/**
 * Panel used to configure the GetCompoundClasses OpenPhacts call.
 * @author Luke Bullard
 *
 */
public class GetCompoundClasses extends AbstractSettingsPanel implements ISettingsPanel<OpenPhactsNodeModel.eMethod, OpenPhactsSettings> {
	/**
	 * Serial Id.
	 */
	...
	private AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetCompoundClassesSettings.URISetting, OpenPhactsSettings> uri = new AbstractMoleculeColumnAndValue<OpenPhactsNodeModel.eMethod, GetCompoundClassesSettings.URISetting, OpenPhactsSettings>() {
		...
		@Override
		protected GetCompoundClassesSettings.URISetting getSettings(OpenPhactsSettings settings) {
			return settings.getCompoundClassesSettings().getURISettings();
		}
	...
	@Override
	public eMethod getMethod() {
		return eMethod.GetCompoundClasses;
	}
