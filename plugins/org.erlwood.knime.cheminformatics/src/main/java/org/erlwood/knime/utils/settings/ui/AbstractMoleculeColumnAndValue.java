 ...
 *
 */
public abstract class AbstractMoleculeColumnAndValue <M extends Enum<M>, T extends AbstractColumnAndValueSettings, V extends AbstractSettings<M>> extends AbstractColumnAndValue<M,T,V> {
	/**
	 * Serial Id.
	 */
	 ...
	 * Constructor.
	 */
	public AbstractMoleculeColumnAndValue() {			
