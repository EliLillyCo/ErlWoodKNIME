 ...
 * @author Luke Bullard
 */
public class XLSWriterNodeFactory extends AbstractErlWoodNodeFactory<XLSWriterNodeModel> {
     ...
     */
    @Override
    public XLSWriterNodeModel createNodeModel() {
    ...
    public NodeView createNodeView(final int viewIndex,
            final XLSWriterNodeModel nodeModel) {
        return null;
    }
