...
public class XLSUserSettings {
    ...
    private boolean m_readNamedRange;
    
    private boolean m_readCertainArea;
    ...
    public XLSUserSettings() {
        ...
        m_readAllData = true;
        m_readNamedRange = false;
        m_readCertainArea = false;
        m_firstRow = -1;
        m_lastRow = -1;
        m_firstColumn = -1;
        m_lastColumn = -1;
    ...
    public void save(final NodeSettingsWO settings) {
        ...
        settings.addString("NAMED_RANGE", m_NamedRange);

        settings.addBoolean("READ_ALL_DATA", m_readAllData);
        settings.addBoolean("READ_NAMED_RANGE", m_readNamedRange);
        settings.addBoolean("READ_CERTAIN_AREA", m_readCertainArea);
    ...
    public String getID() {
        ...
        id.append(getID(m_NamedRange));
        id.append(getID(m_readAllData));
        id.append(getID(m_readNamedRange));
        id.append(getID(m_readCertainArea));
    ...
    public static XLSUserSettings load(final NodeSettingsRO settings)
        ...
        result.m_NamedRange = settings.getString("NAMED_RANGE");

        result.m_readAllData = settings.getBoolean("READ_ALL_DATA");
        result.m_readNamedRange = settings.getBoolean("READ_NAMED_RANGE");
        result.m_readCertainArea = settings.getBoolean("READ_CERTAIN_AREA");
...
//            return "Sheet to read is not specified";
    ...
    public boolean getReadNamedRange() {
    		return m_readNamedRange;
    }
    
    public boolean getReadCertainArea() {
    		return m_readCertainArea;
    }
    /**
    ...
    public void setReadNamedRange(final boolean readNamedRange) {
    	m_readNamedRange = readNamedRange;
    }

    public void setReadCertainArea(final boolean readCertainArea) {
    	m_readCertainArea = readCertainArea;
    }
