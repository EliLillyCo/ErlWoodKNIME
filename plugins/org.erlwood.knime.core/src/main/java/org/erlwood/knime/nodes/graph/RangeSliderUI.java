...
class RangeSliderUI extends BasicSliderUI {
	...
	private transient int upperOffset;
	...
	public void paintTrack(Graphics g) {
		...
		if (slider.getOrientation() == JSlider.HORIZONTAL) {
			...
			g.fillRect(lowerX - trackBounds.x, 0, upperX - lowerX, 3);
	...
	public class RangeTrackListener extends TrackListener {
		...
		public void mousePressed(MouseEvent e) {
			...
			if (lowerPressed == false && upperPressed == false) {
				Rectangle2D.Float r = new Rectangle2D.Float();
				Rectangle2D.union(upperThumbRect, thumbRect, r);
			...
			if (trackPressed) {
				...
				case JSlider.VERTICAL:
					offset = currentMouseY - thumbRect.y;
					upperOffset = currentMouseY - upperThumbRect.y;
					break;
				case JSlider.HORIZONTAL:
					offset = currentMouseX - thumbRect.x;
					upperOffset = currentMouseX - upperThumbRect.x;
					break;
				}
				trackDragging = true;
			}
