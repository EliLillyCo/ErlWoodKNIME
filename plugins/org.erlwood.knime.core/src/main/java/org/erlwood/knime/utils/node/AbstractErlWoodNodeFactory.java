...
/**
 * Abstract NodeFactory for all Erl Wood nodes, will add the Erl Wood node version compatibility to
 * help text.
 * @author Tom Wilkin
 *
 * @param <T> The NodeModel this factory creates.
 */
public abstract class AbstractErlWoodNodeFactory<T extends NodeModel> 
