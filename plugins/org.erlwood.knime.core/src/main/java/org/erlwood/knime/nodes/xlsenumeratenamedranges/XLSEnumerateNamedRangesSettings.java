 ...
 */
public class XLSEnumerateNamedRangesSettings {
     ...
     */
    public static XLSEnumerateNamedRangesSettings load(final NodeSettingsRO settings) throws InvalidSettingsException {
        XLSEnumerateNamedRangesSettings result = new XLSEnumerateNamedRangesSettings();
