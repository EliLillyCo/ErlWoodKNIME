...
class XLSIterator extends CloseableRowIterator {
    ...
    private Name m_currentNamedRange;
    ...
    XLSIterator(final XLSTableSettings settings, final Workbook wb)
        ...
        m_currentNamedRange = m_workBook.getName(m_settings.getNamedRange(wb));
    ...
    private void setNextRow() {
        ...
        while (true) {
            ...
            if ((m_settings.getHasColHeaders()
                    && m_nextRowIdx == m_settings.getColHdrRow()) && (m_settings.getReadNamedRange() == null)) {
            		continue;
            }
